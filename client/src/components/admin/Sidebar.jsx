  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed left-0 top-0 h-full w-70 bg-gray-900 text-white z-50 lg:z-auto lg:translate-x-0 shadow-xl"
        style={{ width: '280px' }}
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-800">
            ...
            <p className="text-sm text-gray-400 mt-1">TryOn Store</p>
          </div>
