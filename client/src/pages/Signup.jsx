...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setMessage('');
        try {
            const res = await api.post('/auth/signup', { name, email, password }); // Use api.post
            ...
            <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-xl shadow-lg">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-300">
                        Or <a href="/login" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
